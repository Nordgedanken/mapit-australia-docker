...
su -l -c "/var/www/mapit/mapit/manage.py mapit_import --country_code DE --area_type_code $CODE --name_type_code $CODE --code_type $CODE --code_field Name --use_code_as_id --generation_id 1 --commit /data/$NAME.kml" mapit
