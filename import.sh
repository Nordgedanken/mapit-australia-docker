...
ls -la /data
ls -la /data/$FILE_NAME.kml
echo "insert"
su -l -c ". /var/www/mapit/virtualenv-mapit/bin/activate; /var/www/mapit/mapit/manage.py mapit_import --country_code DEU --area_type_code LGA --name_type_code LGA --generation_id 1 --commit /data/$FILE_NAME.kml" mapit
#su -l -c "/var/www/mapit/mapit/manage.py mapit_import --country_code DEU --area_type_code $CODE --name_type_code $CODE --name_field "NAME_ENGLISH" --generation_id 1 --commit /data/$FILE_NAME.kml" mapit
