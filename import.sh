...
su -l -c "/var/www/mapit/mapit/manage.py mapit_import --country_code DEU --area_type_code LGA --name_type_code LGA --generation_id 1 --commit /data/$FILE_NAME.kml" mapit
