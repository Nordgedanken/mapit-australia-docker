...
su -l -c "/var/www/mapit/mapit/manage.py mapit_import --country_code DE --area_type_code $CODE --name_type_code $CODE --generation_id 1 --commit /data/$FILE_NAME.kml" mapit
