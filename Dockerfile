...
RUN /import_osm.sh Germany O01 "NAME" "ADMIN_LEVE"
RUN /import_osm.sh Germany O02 "NAME" "ADMIN_LEVE"
RUN /import_osm.sh Germany O03 "NAME" "ADMIN_LEVE"
RUN /import_osm.sh Germany O04 "NAME" "ADMIN_LEVE"
RUN /import_osm.sh Germany O05 "NAME" "ADMIN_LEVE"
RUN /import_osm.sh Germany O06 "NAME" "ADMIN_LEVE"
RUN /import_osm.sh Germany O07 "NAME" "ADMIN_LEVE"
RUN /import_osm.sh Germany O08 "NAME" "ADMIN_LEVE"
RUN /import_osm.sh Germany O09 "NAME" "ADMIN_LEVE"
RUN /import_osm.sh Germany O10 "NAME" "ADMIN_LEVE"
