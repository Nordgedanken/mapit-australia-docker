...
RUN /import.sh DEU_adm_shp CTR 'Local Government Area' NAME_ENGLI DEU_adm0 gadm 'GADM English Name'
RUN /import.sh DEU_adm_shp LGA 'Local Government Area' NAME_0 DEU_adm1 gadm 'GADM English Name'
RUN /import.sh DEU_adm_shp LGA 'Local Government Area' NAME_0 DEU_adm2 gadm 'GADM English Name'
RUN /import.sh DEU_adm_shp LGA 'Local Government Area' NAME_0 DEU_adm3 gadm 'GADM English Name'
RUN /import.sh DEU_adm_shp LGA 'Local Government Area' NAME_0 DEU_adm4 gadm 'GADM English Name'
