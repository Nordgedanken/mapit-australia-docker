...
RUN service postgresql restart && sleep 20; echo "INSERT INTO mapit_country (code, name) VALUES ('DEU', 'Germany');" | su -l -c ". /var/www/mapit/mapit/virtualenv-mapit/bin/activate && psql mapit" mapit
RUN which python
